...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        payload = {'title': 'New reccipe title'}
        url = detail_url(recipe.id)
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Burger')
        in1 = Ingredient.objects.create(user=self.user, name='Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Roll')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Hotdog')
